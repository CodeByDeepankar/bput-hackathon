...
function SheetOverlay({ className, ...props }) { return (
...
function SheetContent({ className, children, side = "right", ...props }) { return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content
        ...
        { ...props }
      >
        {/* Provide a visually-hidden title to satisfy Radix Dialog accessibility requirements
            This ensures screen readers have a dialog title even if callers don't include one. */}
...
function SheetHeader({ className, ...props }) { return (
    <div
...
function SheetTitle({ className, ...props }) { return (
...
function SheetDescription({ className, ...props }) { return (
